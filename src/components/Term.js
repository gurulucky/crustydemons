    ...
    return(
        <section id="term" className='section_style'>
            <Container>
				...
				<p>
					This website is owned and operated by Club Virtual Pty Ltd (ACN 653 514 231), which is the owner of the Demons Club NFT concept, design and all associated intellectual property (“IP”) including the domain name demonsclub.io.  Club Virtual Pty Ltd is also the owner of the Demons Club logo and all associated IP.  Throughout the site and these Terms & Conditions, the term "we", "us", “our”, “Company", “DC”, “demonsclub.io”, “CV” as the context may require, refer to Club Virtual Pty Ltd. By visiting our site and/or purchasing something from us, you engage in our service (“Service”) and agree to be bound by the following terms and conditions (“Terms”).
				</p>
				<p>
				...
				<p>
				This website is for informational purposes and serves as a binding contract for purchasers of DC NFTs.
				</p>
				<p>
				...
				<p>
					Users certify through purchase that they understand that, as the DC smart contract runs on the Ethereum network and is bound by their system and terms, there is no ability to undo, reverse, or restore any transactions.
				</p>
				<p>
					Any connected services included this website are provided “as is” and “as available” without any warranty of any kind. Use of this website constitutes your agreement that you are accepting sole responsibility for any and all transactions involving DC digital collectibles.
				</p>
				<p>
				...
				<p>
					When you purchase your DC NFT, you own the NFT. The ownership is transferred to you on the Ethereum blockchain for that individual piece of art, combination of traits and number. Ownership of the NFT is ruled by the smart contract and the Ethereum Network terms. We have no ability to alter, freeze, seize or modify the ownership of any DC NFT.
				</p>
				<p>
					All buyers acknowledge and agree that, following the purchase of any DC NFT on the website, they do not have any legal ownership right, or title to any copyrights, trademarks or other intellectual property rights to the underlying artwork of the DC NFT. All copyrights and intellectual property rights in the underlying artwork shall remain vested in CV (or in the case of the Demons Club logo shall vest in Demons Club), including but not limited to the right to reproduce, to prepare derivative works, to display, to perform and to distribute the artworks.
				</p>
				<p>
					Following the purchase of a DC NFT on the website, the buyer may display or perform the DC NFT publicly or privately for the purposes of promoting, sharing, discussing or commenting on the buyer’s purchase, ownership or interest in the DC NFT.
				</p>
				<p>
					The buyer of DC NFT may display or perform the NFT on:
				</p>
				<p>
