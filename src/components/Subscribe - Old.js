    ...
    function sendEmail(e){
        ...
        if(isValid){
            if(email !== prev_email){
                ...
                error=>{
                    console.log('Unable send mail', error);
                })
            }
            else{
        ...
        <section id="subscribe">
            <Container>
                <Form onSubmit={sendEmail}>
                        ...
                        <Col lg="3" md="12" sm="12" className='community'>
                            <div>
                                ...
                                <p className="icon">
									...
									<Nav.Link href="https://discord.gg/EVvbPyvSp2" target="_blank"><FaDiscord /></Nav.Link>									
                                </p>
                            </div>
                        </Col>
                    ...
                    {emailvalid === false ? <p style={{color: 'Red', textAlign: 'center'}}>Please enter the correct email address!</p> : null}
                </Form>
