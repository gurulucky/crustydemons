			...
			<Container>
				...
				<Row>
					...
					<Col lg={4} md={12} sm={12}>
						...
						<div className="team_member_intro">
							Whilst Support Artist title is a little unfair as this artist is extremely experienced in his own right with over 10 years of experience in the creation of digital art and digital design.  Responsible for aiding the Chief Artist, including contributing to design thoughts and creative ideas associated with the creation of the Crusty Demons Club NFT images.
						</div>
					</Col>
				</Row>
				<Row>
