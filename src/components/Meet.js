			...
			<Container>
				...
				<Row>
					...
					<Col lg={4} md={12} sm={12}>
						...
						<div className="team_member_intro">
							Experienced international artist with raw talent and significant formal training.  With over 15 years of experience in converting ideas and thoughts from concept drawings to final art including digital art.  Responsible for the design and creation of the Demons Club NFT images with the input and vision from the Team.
						</div>						
					</Col>
					<Col lg={4} md={12} sm={12}>
						<div className="team_member_outline">
				...
				<Row>
					...
					<Col lg={4} md={12} sm={12}>
						...
						<div className="team_member_intro">
							All things social media including Discord, Instagram and Twitter.  Spends his life on social media – poor guy.  Responsible for all things social media for Demons Club, with assistance, input and guidance from the Team.
						</div>
					</Col>
				</Row>
			</Container>
